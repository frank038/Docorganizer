...
THUMB_SIZE = 164
BORDER_WIDTH = 2
# red - green - blue - min 0.0 max 1.0
...
class CellRenderer(Gtk.CellRendererPixbuf):
    ...
    def do_render(self, cr, widget, background_area, cell_area, flags):
        ...
        cr.rectangle(x_offset+xadd, y_offset+yadd, PPIXBUF.get_width(), PPIXBUF.get_height()-1)
        cr.stroke()
...
#########
    ...
    def fthumbnailfile(self, furi):
        ...
        if os.path.exists(thumbfilename):
            ...
            thumbfilename = os.path.join(os.path.expanduser('~/.cache/thumbnails/large'), hmd5) + '.png'
            if os.path.exists(thumbfilename):
                return thumbfilename
            else:
                return None
